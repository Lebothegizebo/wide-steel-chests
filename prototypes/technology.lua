...
data:extend(
{
	...
	{ -- wide steel containers technology
		...
		name = "wide-steel-containers",
	 	icons = { {icon = "__wide-containers-assets__/graphics/technology/wide-steel-containers.png", icon_size = 128} },
	...
	{ -- wide storage containers technology
		...
		icons = { {icon = "__wide-containers-assets__/graphics/technology/wide-logistic-chest.png", icon_size = 128}, {icon = "__wide-containers-assets__/graphics/technology/wide-logistic-chest-mask.png", icon_size = 128, tint = tint_storage} },
